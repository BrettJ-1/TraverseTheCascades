document.addEventListener("DOMContentLoaded", function () {
    ...
    if (window.location.pathname.includes('oregon.html')) {
        ...
        pageTitle.textContent = 'Portland Weather';
        ...
        pageTitle.textContent = 'Seattle Weather';
        ...
        pageTitle.textContent = 'Vancouver Weather';
        ...
        pageTitle.textContent = 'Cannon Beach Weather';
        ...
        pageTitle.textContent = 'Glass Beach Weather';
        ...
        pageTitle.textContent = 'Ruby Beach Weather';
        ...
        pageTitle.textContent = 'Mt. Rainier Weather';
        ...
        pageTitle.textContent = 'Multnomah Falls Weather';
        ...
        pageTitle.textContent = 'Redwoods State Park Weather';
    }
